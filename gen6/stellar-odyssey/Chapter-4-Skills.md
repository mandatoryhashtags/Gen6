...
#### **Physical Skills:**
- **Athletics (PHY):** Running, jumping, swimming, and general physical exertion.
- **Brawl (PHY):** Hand-to-hand combat and unarmed fighting techniques.
- **Melee Combat (PHY):** Proficiency with melee weapons such as swords, knives, clubs, and axes.
- **Acrobatics (AGI):** Climbing, balancing, and performing agile movements.
- **Firearms (AGI):** Proficiency with guns and other ranged weapons.
- **Stealth (AGI):** Moving silently and avoiding detection.
- **Driving (AGI):** Operating ground vehicles.
- **Pilot (AGI)** - Operating Spacecraft/Aircraft
- **Zero-G Maneuvering (AGI):** Moving and operating in zero-gravity environments.
- **Lockpicking (AGI):** Bypassing locks and security devices.
- **Survival (PER):** Tracking, foraging, and knowledge of survival techniques.
- **Computers (LOG):** Using, programming, and hacking computers.
- **Engineering (LOG):** Understanding and repairing mechanical and electrical systems.
- **Investigation (LOG):** Searching for clues, solving puzzles, and piecing together information.
- **Medicine (LOG):** First aid, surgery, and medical knowledge.
- **Science (LOG):** Knowledge of natural and physical sciences, including chemistry, biology, and physics.
- **Xenology (LOG):** Knowledge of alien cultures, technologies
- **Mysticism (LOG):** Knolwedge of supernatural
- **Mechanics (LOG):** Fixing and understanding machinery and engines.
- **Crafting (LOG):** Creating and repairing items, from weapons to tools.
- **Astrogation (LOG):** Calculating and plotting interstellar jumps, navigating space.
- **Notice (PER):** Spotting hidden dangers, noticing small details, and staying aware of your surroundings.
- **Insight (PER):** Reading people’s emotions, detecting lies, and understanding motives.
- **Sense (PER):** Using heightened senses like smell, taste, hearing, and touch to gather information.
- **Charm (SOC):** Persuasion, seduction, and influencing others through charisma.
- **Deception (SOC):** Lying, creating false identities, and trickery.
- **Intimidation (SOC):** Coercing and threatening others to get what you want.
- **Negotiation (SOC):** Bargaining, diplomacy, and resolving conflicts.
- **Leadership (SOC):** Commanding others, inspiring, and managing groups.
- **Energy Weapons (AGI):** Proficiency with energy-based weapons like blasters and plasma rifles.
